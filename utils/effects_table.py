...
def show_effects_table():
    effects = [
        ...
        (22, "Graph", "Эффект как рентген-снимок: тонкие линии, масштабированные детали, монохром с акцентом цветом.", "Средне", "Используй инверсию яркости и выделение тонких структур; цветной акцент может подчеркнуть контуры"),
        (23, "ЦЕНЗУРА", "ЦЕНЗУРА.", "Медленно", "ЦЕНЗУРА."),
    ]
